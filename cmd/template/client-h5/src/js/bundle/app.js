	...
	var Demo = React.createClass({displayName: "Demo",
		...
		render: function(){
			...
			this.state.datas.data.forEach(function(item){
				list.push(React.createElement("li", {className: "list-item"}, "姓名", item.name, "  年龄", item.age))
			});
	    	return React.createElement("div", {className: "sss"}, list);
	  	}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parsePath = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extractPath = __webpack_require__(196);
